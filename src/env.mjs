...
export const env = createEnv({
	...
	server: {
		...
		GOOGLE_API_TYPE: z.string(),
		GOOGLE_API_PROJECT_ID: z.string(),
		GOOGLE_API_PRIVATE_KEY: z.string(),
		GOOGLE_API_PRIVATE_KEY_ID: z.string(),
		GOOGLE_API_CLIENT_EMAIL: z.string(),
		GOOGLE_API_CLIENT_ID: z.string(),
		GOOGLE_API_AUTH_URI: z.string(),
		GOOGLE_API_TOKEN_URI: z.string(),
		GOOGLE_API_AUTH_PROVIDER_X509_CERT_URL: z.string(),
		GOOGLE_API_CLIENT_X509_CERT_URL: z.string(),
		GOOGLE_API_UNIVERSE_DOMAIN: z.string(),
	},
	...
	runtimeEnv: {
		...
		GOOGLE_API_PRIVATE_KEY_ID: process.env.GOOGLE_API_PRIVATE_KEY_ID,
		GOOGLE_API_CLIENT_EMAIL: process.env.GOOGLE_API_CLIENT_EMAIL,
		GOOGLE_API_CLIENT_ID: process.env.GOOGLE_API_CLIENT_ID,
		GOOGLE_API_AUTH_URI: process.env.GOOGLE_API_AUTH_URI,
		GOOGLE_API_TOKEN_URI: process.env.GOOGLE_API_TOKEN_URI,
		GOOGLE_API_AUTH_PROVIDER_X509_CERT_URL: process.env.GOOGLE_API_AUTH_PROVIDER_X509_CERT_URL,
		GOOGLE_API_CLIENT_X509_CERT_URL: process.env.GOOGLE_API_CLIENT_X509_CERT_URL,
		GOOGLE_API_UNIVERSE_DOMAIN: process.env.GOOGLE_API_UNIVERSE_DOMAIN,
	},
});
